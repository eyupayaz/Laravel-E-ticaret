                        ...
                        <div class="section-block" id="basicform">
                            <h3 class="section-title">Setting Edit</h3>
                                        ...
                                        <div class="form-group">
                                            <label for="id" class="col-form-label">İd</label>
                                            <input id="id" type="text" value="{{$data->id}}" class="form-control" name="id">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label for="instegram" class="col-form-label">İnstagram:</label>
