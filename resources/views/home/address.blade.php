        ...
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <div class="mb-4">
                    ...
                    <div class="row">
                        <form class="w-100 row" id="form1" action="{{route('home.shopcart.address')}}" method="post">
                        @csrf
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <button id="form-submit-button" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3">Place Order</button>
                    </div>
                </div>
            </div>
        </div>
