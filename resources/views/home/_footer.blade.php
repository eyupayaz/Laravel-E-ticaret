    ...
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">AYZ</span>Prefabrik</h1>
            </a>
            <p>Sektöre yön veren sayılı firmalardan olan AYZ Prefabrik son sistem teknolojilerle donatılmış sıcak yuvalar ile mutluluğunuza ortak olamaktan gurur duyar.</p>
            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Mersin/Toroslar</p>
            <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>eyupayaz33@gmail.com</p>
            <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+90 536 296 40 90</p>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-dark mb-2" href="index.html"><i class="fa fa-angle-right mr-2">Anasayfa</i></a>
                        <a class="text-dark mb-2" href="shop.html"><i class="fa fa-angle-right mr-2"></i>Hakkımızda</a>
                        <a class="text-dark mb-2" href="detail.html"><i class="fa fa-angle-right mr-2"></i>Ürünler</a>
                        <a class="text-dark mb-2" href="cart.html"><i class="fa fa-angle-right mr-2"></i>Projeler</a>
                        <a class="text-dark mb-2" href="contact.html"><i class="fa fa-angle-right mr-2"></i>İletişim</a>
                    </div>
                </div>
                <div class="col-md-4 mb-5">
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-dark">
                &copy; <a class="text-dark font-weight-semi-bold" href="#">AYZ Prefabrik</a> Tüm hakları saklıdır.

                <a class="text-dark font-weight-semi-bold" href="https://htmlcodex.com"> Eyüp Ayaz</a>
